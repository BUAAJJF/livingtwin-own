...
from livingtwin_mujoco_rl.env import PlanarPushEnv, VectorPlanarPushEnv
...
def collect_rollout(
    vector_env: VectorPlanarPushEnv,
    model: ActorCritic,
...
def train(
    ...
    *,
    ...
    model = ActorCritic(
        PlanarPushEnv.observation_size,
        PlanarPushEnv.action_size,
    ...
    while global_step < total_steps:
        ...
        if global_step >= next_evaluation or global_step == total_steps:
            ...
            metrics, episode_rows = evaluate_policy(
                model,
                normalizer,
